...
I chose this dataset because it puts numerical values to music and music popularity. I find it really interesting how they've chosen to operationalize the songs listed, and I'd like to explore this in more depth.

I'm going to explore the question of how to predict what songs were popular.
...
The target variable is the `popularity` of music. This variable is on a scale from 0 to 100 with 100 being the most popular and 0 being the least. The mean of the variable is 51.5 and the median is 55. The distribution is visually centered around approximately 65 with a left skew, as you can see in the histogram below.
